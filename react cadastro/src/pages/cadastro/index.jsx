...
function Cadastro() {
  ...
  return (
    <div className="max-w-md mx-auto mt-10 bg-white p-8 border border-gray-300 rounded-lg">
      <h2 className="text-2xl font-bold mb-6 text-center text-gray-700">Casdratro</h2>
      ...
      <Link to={"/login"} className="text-blue-700 hover:underline mt-4 block text-center">Já tem uma conta? Faça o login</Link>
    </div>
  );
}
